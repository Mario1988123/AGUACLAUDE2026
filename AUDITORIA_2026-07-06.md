...
**Fase D (tests) — EN CURSO** (commits 30853bd, 26f329e, 0396d4b): infraestructura
vitest + **82 tests** de lógica pura sin BD, todos verdes:
...
- Validaciones ES: DNI/NIE/CIF/IBAN (mod-97)/CP/teléfono/provincias + IBAN parcial.
