...
async function ensureAdminOrLevel2() {
  ...
  if (
    ...
    throw new Error("Solo admin / director puede asignar financiera al contrato");
  }
  return session;
}
...
export async function assignFinancierToContractAction(input: unknown): Promise<void> {
