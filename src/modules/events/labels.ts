export const EVENT_LABEL: Record<string, string> = {
  ...
  "free_trial.installed": "Prueba instalada",
  "free_trial.accepted": "Prueba aceptada — contrato generado",
  "free_trial.rejected": "Prueba rechazada",
  "free_trial.returned": "Prueba retirada (stock devuelto)",
  "equipment.relocation_requested": "Reubicación de equipo solicitada",
  "equipment.uninstall_requested": "Desinstalación solicitada",
  "installation.unscheduled_by_incident": "Instalación desagendada por incidencia",
  "installation.tomorrow": "Instalación programada para mañana",
  "loading.suggested": "Sugerencia de carga generada",
  "loading.pending": "Carga pendiente al fichar",
  "loading.batch": "Órdenes de carga generadas",
  "stock.low": "Stock bajo",
  "stock_transfer": "Traspaso de stock",
  "contract_signed": "Contrato firmado",
  "contract_signed_tmk_split": "Comisión TMK por contrato firmado",
  "contract_closure_bonus": "Bonus por cierre de contrato",
  "contract_cancelled": "Contrato cancelado (puntos revertidos)",
  "sale": "Venta confirmada",
  "sale_with_discount": "Venta con descuento",
  "sale_tmk_split": "Comisión TMK por venta",
  ...
  "personal_data.exported": "Exportación de datos personales (CSV)",
  "gocardless.mandate_lost": "Mandato SEPA cancelado / perdido",
  "verifactu.failed": "Factura(s) rechazadas por AEAT",
  "incident.sla_breach": "Incidencia fuera de plazo (SLA)",
